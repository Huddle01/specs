...
Orchestrator holds the logic to manage different work being done by the media nodes and any custom logic which is required to be implemented
as per the requirements of different organizations.

<Callout title="More about Orchestrator" type="info">
  Learn about the role of Orchestrator in the dRTC network.
